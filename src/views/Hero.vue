...
<template>
    <div class="relative isolate overflow-hidden bg-black">
        ...
        <div class="px-4 sm:px-8 py-14 sm:py-20 max-w-6xl mx-auto lg:flex">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <div class="rounded-full border border-fuchsia-300 px-4 py-0.5 text-sm text-white inline-block mt-16">
                    Features
                </div>
